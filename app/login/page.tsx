...
const LoginPageContent = () => {
 ...
 searchParams.get('signupSuccess') ==='true'?'Your account has been created. Please check your email and verify your address before logging in.':''
 );
 ...
 {successMessage && (
 <div className="bg-emerald-50 border border-emerald-200 text-emerald-600 p-3 rounded-lg flex items-center gap-2 text-sm">
