...
return (
 ...
 className="text-lg w-[300px] text-[#EFE5E4] border-[#d1d5db]"
 rows={4}
 
 />
 </div>
 <div className="mt-8">
 <h2 className="text-sm font-bold text-[#EFE5E4] uppercase tracking-wide mb-2">{t.billTo}</h2>
 <EditableField
 value={data.to}
 onChange={handleDataChange}
 name="to"
 placeholder={"Client Company\n456 Client Street\nClient City, ST 54321\nclient@email.com"}
 className="text-lg text-[#EFE5E4] w-[300px] border-[#d1d5db]"
 rows={4}
 />
 </div>
 </div>
 ...
 onChange={handleDataChange}
 name="invoiceNumber"
 className="text-right mt-2 text-[#EFE5E4] font-semibold border-[#d1d5db]"
 style={{ width:'220px'}}
 />
 </div>
 <div className="space-y-2 mt-[50px]">
 <div className="grid grid-cols-[1fr_auto] items-center gap-4">
 <span className="font-semibold text-[#EFE5E4] text-right">{t.date}</span>
 <EditableField type="date"name="date"value={data.date} onChange={handleDataChange} 
 className="w-[130px] text-right text-[#EFE5E4] max-w-40 border-[#d1d5db]"/>
 
 </div>
 <div className="grid grid-cols-[1fr_auto] items-center gap-4">
 <span className="font-semibold text-[#EFE5E4] text-right">{t.dueDate}</span>
 ...
 <span className="font-semibold text-[#EFE5E4] text-right">{t.paymentTerms}</span>
 <EditableField type="text"name="paymentTerms"value={data.paymentTerms} onChange={handleDataChange} placeholder="e.g. Net 15"
 className="w-[130px] text-right text-[#EFE5E4] max-w-36 border-[#d1d5db]"/>
 </div>
 <div data-export-id="po-number-row"className="grid grid-cols-[1fr_auto] items-center gap-4">
 <span className="font-semibold text-[#EFE5E4] text-right">{t.poNumber}</span>
 ...
 <thead>
 <tr className="text-bold text-[#EFE5E4]">
 ...
 className="w-[420px] text-left text-[#EFE5E4] border-[#d1d5db]"/>
 </td>
 ...
 className="w-[90px] text-center text-[#EFE5E4] border-[#d1d5db]"/>
 </td>
 ...
 className="w-[110px] text-right text-[#EFE5E4] border-[#d1d5db]"/>
 </td>
 <td className="py-2 pl-1 pr-0 text-right align-top text-[#EFE5E4]">{currencySymbol}{formatNumber(Number(item.quantity) * Number(item.price))}</td>
 ...
 <button onClick={addItem} className="mt-4 px-4 py-2 border-2 border-dashed border-gray-300 text-[#EFE5E4] rounded-md hover:border-primary-500 hover:text-primary-500 transition-all preview-only">{t.addLineItem}</button>
 ...
 <dl className="space-y-2 text-[#EFE5E4]">
 ...
 className="max-w-20 text-right text-[#EFE5E4] border-[#d1d5db] flex-shrink-0"/>
 <span>%</span>
 </dd>
 </div>
 <div data-export-id="tax-row"className="text-[#EFE5E4] flex justify-between items-center">
 <dt>{t.tax}</dt>
 <dd className="flex items-center">
 <EditableField 
 type="number"
 ...
 <div data-export-id="total-row"className="flex justify-between font-bold text-lg pt-2 border-t border-gray-300 text-[#EFE5E4]">
 <dt>{t.total}</dt>
 ...
 onChange={handleDataChange}
 className="text-right text-[#EFE5E4] border-[#d1d5db] flex-shrink-0"
 placeholder="0.00"
 style={{ width:'120px'}}
 />
 </dd>
 </div>
 <div data-export-id="balance-due-row"className="flex justify-between font-bold text-xl pt-2 mt-2 border-t border-gray-300 text-[#EFE5E4] balance-due-row">
 <dt>{t.balanceDue}</dt>
 ...
 <p className="text-xs text-[#EFE5E4] mt-1 max-w-[96px] text-center">{t.qrCodeHelper}</p>
 </div>
 )}
 </div>
 ...
 <p className="text-sm font-semibold text-[#EFE5E4]">{t.authorizedSignature}</p>
 </div>
 </div>
 </div>
 </div>
