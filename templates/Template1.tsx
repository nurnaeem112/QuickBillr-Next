...
const Template1: React.FC<Template1Props> = ({
 ...
 className="text-lg w-[300px] text-[#000000] border-[#d1d5db]"
 rows={4}
 />
 </div>
 <div className="mt-8">
 ...
 className="text-lg text-[#000000] w-[300px] border-[#d1d5db]"
 rows={4}
 />
 </div>
 </div>
 ...
 onChange={handleDataChange}
 name="invoiceNumber"
 className="text-right mt-2 text-[#000000] font-semibold border-[#d1d5db]"
 style={{
 width:'150px'
 }} 
 />
 ...
 className="text-right text-[#000000] max-w-40 border-[#d1d5db]"
 style={{
 width:'125px'
 }}
 />
 ...
 className="text-right text-[#000000] flex-shrink-0 border-[#d1d5db]"
 style={{
 width:'125px'
 }}
 />
 ...
 className="w-[420px] text-left text-[#000000] border-[#d1d5db]"/>
 </td>
 ...
 className="w-[90px] text-center text-[#000000] border-[#d1d5db]"/>
 </td>
 ...
 className="w-[110px] text-right text-[#000000] border-[#d1d5db]"/>
 </td>
 ...
 onChange={handleDataChange}
 rows={2}
 className="text-[#000000] border-[#d1d5db]"
 ...
 className="mt-1 text-[#000000] border-[#d1d5db]"/>
 </div>
 </div>
 ...
 className="max-w-20 text-right text-[#000000] border-[#d1d5db] flex-shrink-0"/>
 <span>%</span>
 </dd>
 </div>
 ...
 onChange={handleDataChange}
 className="text-right text-[#000000] border-[#d1d5db] flex-shrink-0"
 placeholder="0.00"
 style={{
 width:'120px'
 }}
